(function ( $ ) {
	...
	$(function () {
		...
		$("#e7").select2({
			id: function( plugin ){ return plugin.slug },
			...
			ajax: {
				...
				results: function (data, page) {
					var more = page < data.info.pages; // whether or not there are more results available
		...
		}).on("select2-selecting", function(e) { console.log ( "selecting val="+ e.val ); });
